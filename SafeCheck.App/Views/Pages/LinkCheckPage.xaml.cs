...
public partial class LinkCheckPage : Page
{
    private readonly Frame _frame;

    public LinkCheckPage(Frame frame)
    {
        InitializeComponent();
        _frame = frame;
    }
    ...
    {
        if (e.Key == Key.Enter && DataContext is LinkCheckVM vm && vm.ScanCommand.CanExecute(null))
        {
