...
public partial class PhoneCheckPage : Page
{
    private readonly Frame _frame;

    public PhoneCheckPage(Frame frame)
    {
        InitializeComponent();
        _frame = frame;
    }
    ...
    {
        if (e.Key == Key.Enter && DataContext is PhoneCheckVM vm && vm.ScanCommand.CanExecute(null))
        {
